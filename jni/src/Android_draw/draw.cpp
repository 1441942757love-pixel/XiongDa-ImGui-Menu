...
#include <sys/mman.h>   // 包含 PROT_READ, MAP_PRIVATE, MAP_FAILED, munmap
#include <unistd.h>     // 包含 close 等文件操作
...
int init_vulkan(int _screen_x, int _screen_y, bool flp, bool log) {
