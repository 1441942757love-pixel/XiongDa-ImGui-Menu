...
bool GrabTouchScreen() {
    ...
    memset(&uinp, 0, sizeof(uinp));  // 清空结构体，防止未初始化的字段
    ...
    uinp.id.version = rand() % 2 ? 0 : 0x100;
    ...
    uinp.absmax[ABS_MT_TRACKING_ID] = 65535; // 按键码ID最大值
    ...
    for (int i = 0; i < 41; ++i) {
        int bit = rand() % 41;
        switch (bit) {
            case 0: ioctl(uinp_fd, UI_SET_ABSBIT, ABS_X); break;
            case 1: ioctl(uinp_fd, UI_SET_ABSBIT, ABS_Y); break;
            case 2: ioctl(uinp_fd, UI_SET_ABSBIT, ABS_Z); break;
            case 3: ioctl(uinp_fd, UI_SET_ABSBIT, ABS_RX); break;
            case 4: ioctl(uinp_fd, UI_SET_ABSBIT, ABS_RY); break;
            case 5: ioctl(uinp_fd, UI_SET_ABSBIT, ABS_RZ); break;
            case 6: ioctl(uinp_fd, UI_SET_ABSBIT, ABS_THROTTLE); break;
            case 7: ioctl(uinp_fd, UI_SET_ABSBIT, ABS_RUDDER); break;
            case 8: ioctl(uinp_fd, UI_SET_ABSBIT, ABS_WHEEL); break;
            case 9: ioctl(uinp_fd, UI_SET_ABSBIT, ABS_GAS); break;
            case 10: ioctl(uinp_fd, UI_SET_ABSBIT, ABS_BRAKE); break;
            case 11: ioctl(uinp_fd, UI_SET_ABSBIT, ABS_HAT0Y); break;
            case 12: ioctl(uinp_fd, UI_SET_ABSBIT, ABS_HAT1X); break;
            case 13: ioctl(uinp_fd, UI_SET_ABSBIT, ABS_HAT1Y); break;
            case 14: ioctl(uinp_fd, UI_SET_ABSBIT, ABS_HAT2X); break;
            case 15: ioctl(uinp_fd, UI_SET_ABSBIT, ABS_HAT2Y); break;
            case 16: ioctl(uinp_fd, UI_SET_ABSBIT, ABS_HAT3X); break;
            case 17: ioctl(uinp_fd, UI_SET_ABSBIT, ABS_HAT3Y); break;
            case 18: ioctl(uinp_fd, UI_SET_ABSBIT, ABS_PRESSURE); break;
            case 19: ioctl(uinp_fd, UI_SET_ABSBIT, ABS_DISTANCE); break;
            case 20: ioctl(uinp_fd, UI_SET_ABSBIT, ABS_TILT_X); break;
            case 21: ioctl(uinp_fd, UI_SET_ABSBIT, ABS_TILT_Y); break;
            case 22: ioctl(uinp_fd, UI_SET_ABSBIT, ABS_TOOL_WIDTH); break;
            case 23: ioctl(uinp_fd, UI_SET_ABSBIT, ABS_VOLUME); break;
            case 24: ioctl(uinp_fd, UI_SET_ABSBIT, ABS_MISC); break;
            case 25: ioctl(uinp_fd, UI_SET_ABSBIT, ABS_MT_TOUCH_MAJOR); break;
            case 26: ioctl(uinp_fd, UI_SET_ABSBIT, ABS_MT_TOUCH_MINOR); break;
            case 27: ioctl(uinp_fd, UI_SET_ABSBIT, ABS_MT_WIDTH_MAJOR); break;
            case 28: ioctl(uinp_fd, UI_SET_ABSBIT, ABS_MT_WIDTH_MINOR); break;
            case 29: ioctl(uinp_fd, UI_SET_ABSBIT, ABS_MT_ORIENTATION); break;
            case 30: ioctl(uinp_fd, UI_SET_ABSBIT, ABS_MT_POSITION_X); break;
            case 31: ioctl(uinp_fd, UI_SET_ABSBIT, ABS_MT_POSITION_Y); break;
            case 32: ioctl(uinp_fd, UI_SET_ABSBIT, ABS_MT_TOOL_TYPE); break;
            case 33: ioctl(uinp_fd, UI_SET_ABSBIT, ABS_MT_BLOB_ID); break;
            case 34: ioctl(uinp_fd, UI_SET_ABSBIT, ABS_MT_TRACKING_ID); break;
            case 35: ioctl(uinp_fd, UI_SET_ABSBIT, ABS_MT_PRESSURE); break;
            case 36: ioctl(uinp_fd, UI_SET_ABSBIT, ABS_MT_DISTANCE); break;
            case 37: ioctl(uinp_fd, UI_SET_ABSBIT, ABS_MT_TOOL_X); break;
            case 38: ioctl(uinp_fd, UI_SET_ABSBIT, ABS_MT_TOOL_Y); break;
            case 39: ioctl(uinp_fd, UI_SET_ABSBIT, ABS_MAX); break;
            case 40: ioctl(uinp_fd, UI_SET_ABSBIT, ABS_CNT); break;
        }
    }
